...
router.post("/:username/follow", verifyFirebaseToken, userController.followUser);
router.post("/:username/unfollow", verifyFirebaseToken, userController.unfollowUser);
